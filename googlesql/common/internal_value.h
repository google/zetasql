...
#ifndef GOOGLESQL_COMMON_INTERNAL_VALUE_H_
#define GOOGLESQL_COMMON_INTERNAL_VALUE_H_
...
class InternalValue {
 public:
  ...
  // there are forks of the reference implementation outside googlesql code that
...
#endif  // GOOGLESQL_COMMON_INTERNAL_VALUE_H_
