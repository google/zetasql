...
final class Client {
  ...
  /** Returns the stub that can be used to call RPC of the ZetaSQL server. */
  static synchronized ZetaSqlLocalServiceGrpc.ZetaSqlLocalServiceBlockingStub getStub() {
    if (stub == null) {
