...
// zetasql_base::zetasql_base_internal::Invoke(f, args...) is an implementation
// of INVOKE(f, args...) from section [func.require] of the C++ standard.
//
// [func.require]
...
#ifndef THIRD_PARTY_ZETASQL_ZETASQL_BASE_INVOKE_H_
#define THIRD_PARTY_ZETASQL_ZETASQL_BASE_INVOKE_H_
...
#endif  // THIRD_PARTY_ZETASQL_ZETASQL_BASE_INVOKE_H_
