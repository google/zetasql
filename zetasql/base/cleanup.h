...
#ifndef THIRD_PARTY_ZETASQL_ZETASQL_BASE_CLEANUP_H_
#define THIRD_PARTY_ZETASQL_ZETASQL_BASE_CLEANUP_H_
...
//     auto fp_cleaner = zetasql_base::MakeCleanup([fp] { fclose(fp); });
...
// destroyed. Cleanup<F> is the return type of zetasql_base::MakeCleanup(F).
template <typename F>
class Cleanup {
 public:
  Cleanup()
...
#endif  // THIRD_PARTY_ZETASQL_ZETASQL_BASE_CLEANUP_H_
